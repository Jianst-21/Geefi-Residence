        ...
        <div>
          ...
          <ul className="flex flex-col gap-2.5 list-none p-0 m-0">
            <li className="flex gap-2 items-center text-xs text-secondary/80">
              ...
              Dusun 3, Begajah, Kec. Sukoharjo, Kabupaten Sukoharjo, Jawa Tengah 57551
            </li>
            <li className="flex gap-2 items-center text-xs text-secondary/80">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-4 list-none p-0 m-0">
            <li className="flex gap-2 items-center text-xs text-secondary/80">
              ...
              <Link
                href="https://www.facebook.com/aapn.2025/?rdid=ffq92EP59jkYEbPE"
                target="_blank"
            ...
            <li className="flex gap-2 items-center text-xs text-secondary/80">
              ...
              <Link
                href="https://www.instagram.com/geefiresidence/"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-primary transition-colors"
              >
            ...
            <li className="flex gap-2 items-center text-xs text-secondary/80">
              ...
              <Link
                href="https://www.tiktok.com/@geefiresidence"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-primary transition-colors"
              >
            ...
            <li className="flex gap-2 items-center text-xs text-secondary/80">
              ...
              <Link
                href="https://api.whatsapp.com/send/?phone=6288215012059&text&type=phone_number&app_absent=0"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-primary transition-colors"
              >
