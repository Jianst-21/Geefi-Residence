        ...
        <div className="mb-4 w-[calc(100vw-3rem)] md:w-[360px] max-h-full bg-[#FCFCFD] rounded-[40px] shadow-[0_20px_50px_rgba(0,0,0,0.15)] overflow-hidden flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-300 pointer-events-auto origin-bottom-right">
          ...
          <div className="bg-[#9C6B1B] px-6 py-4 text-white relative flex-shrink-0">
            <button 
              ...
              className="absolute top-4 right-5 text-white/80 hover:text-white transition-colors"
            >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-[15px] font-bold leading-tight tracking-wide">Asisten Geefi</h3>
          ...
          <div className="flex-1 overflow-y-auto px-6 pt-6 pb-3 custom-scrollbar bg-white">
            ...
            <div className="bg-[#FCFCFD] p-5 rounded-[28px] border border-[#D4C4B1]/30 mb-4">
              <div className="mb-5">
                <h4 className="text-gray-900 font-bold text-[14px]">Konsultasi Eksklusif</h4>
                <p className="text-[11px] text-gray-500 mt-1">Lengkapi data untuk terhubung langsung.</p>
              </div>

              <form onSubmit={sendToWhatsApp} className="space-y-4">
                <div>
                  <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1.5 ml-2">Nama Lengkap</label>
                  <input 
                    name="nama"
                ...
                <div>
                  <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1.5 ml-2">Nomor WhatsApp</label>
                ...
                <div>
                  <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1.5 ml-2">Pilih Tipe Unit</label>
                  <div className="relative">
                    <select 
                      name="unit"
                      onChange={handleInputChange}
                ...
                >
                  <MessageCircle size={16} className="text-white" /> Hubungkan ke WhatsApp
                </button>
              </form>
            </div>
          </div>
