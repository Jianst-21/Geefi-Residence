    ...
    <section className="py-20 bg-[#F4F3F1]">
      <div className="max-w-[1184px] mx-auto px-6 lg:px-0">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-6 lg:gap-[32px]">
          ...
          {units.map((unit) => (
            <div key={unit.id} className="w-full md:w-[363px] flex flex-col mx-auto font-['Manrope']">
              ...
              <div className="relative w-full h-[453px] rounded-[40px] overflow-hidden mb-6 group cursor-pointer bg-gray-200">
                ...
                <div className="absolute top-6 left-6 bg-white/95 backdrop-blur-sm px-4 py-1.5 rounded-full shadow-sm">
                  <span className="text-[#8E6319] text-[10px] font-bold tracking-widest uppercase">
                    {unit.badge}
                  </span>
                </div>
              </div>
