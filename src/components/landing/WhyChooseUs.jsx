    ...
    <section className="bg-[#FAF9F6] pt-[48px] pb-0 md:pt-[80px] md:pb-0">
      <div className="max-w-7xl mx-auto px-6 sm:px-10">
        ...
        <div className="text-center flex flex-col items-center mb-[24px] md:mb-[64px]">
          <h2 className="w-full max-w-[616px] text-3xl md:text-[32px] leading-[40px] font-bold text-gray-900 mb-4 font-['Manrope'] flex items-center justify-center">
            Mengapa Memilih Abyakta?
          </h2>
          <p className="w-full max-w-[672px] text-gray-500 text-sm md:text-[16px] leading-[24px] flex items-start justify-center">
