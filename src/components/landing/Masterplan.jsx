    ...
    <>
      <section className="bg-white pt-[46.5px] lg:pt-[64px] pb-0 lg:pb-[53px] font-['Manrope']">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-[48px]">
          ...
          <div className="w-full bg-[#F4F3F1] rounded-[48px] flex flex-col lg:flex-row min-h-[781px] overflow-hidden shadow-sm border border-gray-100">
            ...
            <div className="w-full lg:w-[320px] shrink-0 bg-white p-6 md:p-8 flex flex-col border-t lg:border-t-0 lg:border-l border-gray-100">
              ...
              {selectedPlot ? (
                <div className="flex flex-col md:flex-row lg:flex-col gap-6 md:gap-8 lg:gap-0 h-full">
                  <div className="flex-1 flex flex-col justify-between">
                    <div className="mb-6 md:mb-0 lg:mb-8">
                    ...
                    <div className="flex justify-between gap-2 mb-6 md:mb-0 lg:mb-8 mt-auto">
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    <div className="w-full h-[180px] bg-gray-50 rounded-[20px] mb-6 md:mb-4 lg:mb-8 overflow-hidden relative border border-gray-200 shadow-sm">
